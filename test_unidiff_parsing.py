...
""")
        ...
        # Generate patch
        result = subprocess.run(['git', 'diff', 'HEAD'], cwd=repo_dir, capture_output=True, text=True, check=True)
        ...
        with open(patch_file, 'r') as f:
            subprocess.run(['git', 'apply'], cwd=repo_dir, input=f.read(), text=True, check=True)
